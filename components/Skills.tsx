...
import { Code2Icon, PaletteIcon } from "lucide-react";
import { easeInOut, motion } from "framer-motion";
export default function Skills() {
  return (
    <>
      <section className="min-h-screen container mx-auto flex justify-center items-center">
        <div className="min-h-fit  grid grid-cols-1 md:grid-cols-3 text-white align-middle  md:gap-8 mx-2 md:mx-0">
          {/* first card */}
          ...
          {/* second card */}
          <div className="bg-linear-to-t md:bg-linear-to-l from-slate-800 rounded-lg hover:border-indigo-600  flex flex-col justify-center items-center text-center p-5">
            <motion.div
              initial={{ opacity: 0, y: -20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 1.3, ease: easeInOut }}
